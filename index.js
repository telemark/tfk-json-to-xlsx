...
module.exports = (function () {
  ...
  XlsxWriter.prototype.dispose = function () {
    ...
    return this.disposed = true // eslint-disable-line
  }
  ...
  XlsxWriter.prototype._addCell = function (value, col) {
    ...
    if (typeof value === 'number') {
      return this.rowBuffer += blobs.numberCell(value, cell) // eslint-disable-line
    } else if (value instanceof Date) {
      date = this._dateToOADate(value)
      return this.rowBuffer += blobs.dateCell(date, cell) // eslint-disable-line
    } else {
      index = this._lookupString(value)
      return this.rowBuffer += blobs.cell(index, cell) // eslint-disable-line
    }
  }

  XlsxWriter.prototype._startRow = function () {
    this.rowBuffer = blobs.startRow(this.currentRow)
    return this.currentRow += 1 // eslint-disable-line
  }
  ...
  XlsxWriter.prototype._generateStrings = function () {
    ...
    return this.stringsData = blobs.stringsHeader(this.strings.length) + stringTable + blobs.stringsFooter // eslint-disable-line
  }
  ...
  XlsxWriter.prototype._generateRelationships = function () {
    return this.relsData = blobs.externalWorksheetRels(this.relationships) // eslint-disable-line
  }
